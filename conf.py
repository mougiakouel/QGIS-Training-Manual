# -*- coding: utf-8 -*-
#
# Linfiniti QGIS Training Manual documentation build configuration file, created by
...
htmlhelp_basename = 'LinfinitiQGISTrainingManualdoc'
...
latex_documents = [
  ('index', 'LinfinitiQGISTrainingManual.tex', u'Quantum GIS Training Manual',
   u'R. Thiede, T. Sutton, H. Düster, M. Sutton', 'manual'),
]
...
man_pages = [
    ('index', 'linfinitiqgistrainingmanual', u'Linfiniti QGIS Training Manual Documentation',
     [u'Tim Sutton, Rudi Thiede'], 1)
]
...
texinfo_documents = [
  ('index', 'LinfinitiQGISTrainingManual', u'Linfiniti QGIS Training Manual Documentation',
   u'Tim Sutton, Rudi Thiede', 'LinfinitiQGISTrainingManual', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Linfiniti QGIS Training Manual'
epub_author = u'Tim Sutton, Rudi Thiede'
epub_publisher = u'Tim Sutton, Rudi Thiede'
epub_copyright = u'2012, Tim Sutton, Rudi Thiede'
